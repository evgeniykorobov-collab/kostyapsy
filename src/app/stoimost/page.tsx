...
export default function StoimostPage() {
  ...
  const special: Tariff[] = [
    ...
    },
    {
      icon: Headphones,
      title: 'Супервизия',
      subtitle: 'Разбор сложных случаев для коллег',
      price: '12 000 ₽',
      description: '60 минут онлайн. Вы рассказываете случай — я даю структурный разбор и рекомендации. Без оценок, с уважением к вашему опыту.',
      result: 'Слепые зоны подсвечены, тупиковый кейс получил выход.',
    },
  ];
